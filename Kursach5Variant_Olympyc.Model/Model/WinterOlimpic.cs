...
namespace Kursach5Variant_Olympyc.Model.Model
{
    public class WinterOlimpic
    {
        ...
        public void GetInformationAboutPlacesEveryCountry(string countryName, out int numberOFGold, out int numberOfSilver, out int numberOfBronze,out List<Sporstman> countryWinners)
        {
            numberOFGold = 0;
            numberOfSilver = 0;
            numberOfBronze = 0;
